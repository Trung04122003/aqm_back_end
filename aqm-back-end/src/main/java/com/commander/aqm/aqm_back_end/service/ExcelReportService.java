...
public class ExcelReportService {
    ...
    private void createSummarySheet(Workbook workbook, Report report) {
        ...
        titleCell.setCellValue("🎄 AIR QUALITY REPORT 🎄");
        ...
        createRow(sheet, rowNum++, "Average PM2.5",
                String.format("%.2f µg/m³", report.getAvgPm25()), headerStyle, dataStyle);
        createRow(sheet, rowNum++, "Average PM10",
                String.format("%.2f µg/m³", report.getAvgPm10()), headerStyle, dataStyle);
        ...
        // Distribution
        createRow(sheet, rowNum++, "Good Days (AQI ≤ 50)",
    ...
    private void createDistributionSheet(Workbook workbook, Report report) {
        ...
        goodRow.createCell(0).setCellValue("😊 Good (AQI ≤ 50)");
        ...
        moderateRow.createCell(0).setCellValue("😐 Moderate (51-100)");
        ...
        unhealthyRow.createCell(0).setCellValue("😷 Unhealthy (> 100)");
